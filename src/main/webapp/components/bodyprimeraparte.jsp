<%-- 
    ...
    Created on : Nov 7, 2024, 8:48:19 AM
...
<body id="page-top">
    ...
    <% HttpSession miSession =   request.getSession();
        String sessionValida = (String) request.getSession().getAttribute("usuario");
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities1" class="collapse" aria-labelledby="headingUtilities1"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Acciones:</h6>
                        <a class="collapse-item" href="SvUsuarios?method=GET" >Ver Usuarios</a>
